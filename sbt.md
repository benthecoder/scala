...
- [sbt guide](#sbt-guide)
  ...
  - [sbt modes](#sbt-modes)
  - [Create an sbt Scala project](#create-an-sbt-scala-project)
  ...
  - [Tips](#tips)
    - [Tip 1: Getting the right Scala version with %%](#tip-1-getting-the-right-scala-version-with-)
    - [Tip 2: Cross-compilation for multiple Scala versions](#tip-2-cross-compilation-for-multiple-scala-versions)
    - [Tip 3: Pass options to Scala compiler](#tip-3-pass-options-to-scala-compiler)
    - [Tip 4: View compile classpath dependencies](#tip-4-view-compile-classpath-dependencies)
    - [Tip 5: View dependency graph](#tip-5-view-dependency-graph)
